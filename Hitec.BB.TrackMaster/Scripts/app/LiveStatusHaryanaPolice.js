            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        ...
                        if (full.ProgressStatus == "Moving" || full.ProgressStatus == "Hispeed" || full.ProgressStatus == "IgnitionOn") {
                            return '<span>' + '<img src="' + VehStatus + '">' + '<img src="../../resources/images/legends/ignitionblink.gif" style="width:32px;"/></span>';
                        }
                ...
                },
                {
                ...
                },
                 {
                     ...
                     "render": function (data, type, full, meta) {
                         ...
                         if (full.ACTooltip == "AC Off" || full.ACTooltip == "AC On") {


                             if (full.FuelActiveNTM == "1") {
                                 return '<span title="For Details go to add-on report"><b style="color:grey;"  ><a href="/AddOn/ac?vehName=' + full.VehicleName + '">' + full.AcActive + '</a></b></br><b style="color:grey;"><a href="/fuel/FuelGraph?bbid=' + full.BBID + '"><img src="../../Trackmaster_files/Fuel/Fuel.png" /></a></b>' +
                                     '</span>';
                             }
                             else {
