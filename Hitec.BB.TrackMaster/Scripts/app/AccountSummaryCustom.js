...
function GetBillingInfo() {
    debugger;
    var url = baseUrl + "AdminAPI/BillSummarydata";
    var vehicleId = 0;
        ...
        "columns": [
...

                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        var aTag = '<a href="BillCustom?billperiodid=' + data.billperiodid + '&BillNo=' + data.billno + '&FromDate=' + data.FromDate + '&custid=' + data.custid + '">View Bill</a>';
