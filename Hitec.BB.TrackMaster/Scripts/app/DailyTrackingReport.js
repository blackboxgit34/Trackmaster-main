...
function format(d) {
    ...
    if (data.Datacount > 0) {
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr><th>Data Date</th><th>Start Location</th><th>Start Date Time</th><th>End Location</th><th>End Date Time</th> <th>Operated KM</th><th>Daily KM</th></tr></thead>';
        data.TrackChildModel.forEach(function (element) {
            
            console.log(element);
            tableString = tableString +
           '<tr>' +
            '<td>' + element.DataDate + '</td>' +
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "TrackingAPI/GetDailytracking";
...
function GetTripSummaryReport(tableName, downloadType) {
    ...
    //var $custid = '4939';
    var $BBID = '';
    var url = apiBase.apiurl + "TrackingAPI/GetDailytracking";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'UTCTracking_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
