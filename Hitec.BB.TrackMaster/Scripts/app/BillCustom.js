...
function GetBillInfo() {
    ...
    var id = getUrlParameter('custid');
    var billDetails = {
        CustID: id, BillPeriodID: BillPeriodID, BillNo: BillNo, FromDate: FromDate
    }
...
function GetVehicleDetails() {
    ...
    var table = $('#dt_basic_Master').DataTable({
        ...
        "fnServerParams": function (param) {
            param.push({ "name": "CustID", "value": id }, { "name": "BillPeriodID", "value": BillPeriodID }, { "name": "FromDate", "value": FromDate });
        },
        "columns": [
                {
                    "data": "ROW_NO",
