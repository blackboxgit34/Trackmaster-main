...
function GetEntryExitReport() {
    ...
    //  $custid = '6627';
    var url = baseUrl + "CustomAPI/POIEntryExitReport";
    ...
    table = $('#dt_basic_Master').DataTable({
        ...
        "fnServerParams": function (param) {
            param.push({ "name": "beginDate", "value": $beginDate }, { "name": "endDate", "value": $endDate }, { "name": "bbid", "value": "" }, { "name": "custid", "value": $custid }, { "name": "downloadType", "value": null }, { "name": "reportName", "value": 'Entry-Exit Report' });
        },
