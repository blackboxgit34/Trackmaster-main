...
function LiveStatus() {
    if (liveStatusAuto) {
        ...
        deleteTable();
        var url = apiBase.apiurl + "LiveStatus/LiveStatusNavkar";
        sum = 0;
            ...
            "columns": [
                ...
                },
                {
                ...
                },
                 {
                     "render": function (data, type, full, meta) {
                         //return '<a href="/Report/Details?bbid=' + full.BBID + '">' + full.VehicleName + '</a>';
                         return '<span>' + full.transportname + '</span>';
                 ...
                 },
                  {
                      "render": function (data, type, full, meta) {
                          //return '<a href="/Report/Details?bbid=' + full.BBID + '">' + full.VehicleName + '</a>';
                          return '<span>' + full.groupname + '</span>';
                  ...
                  },
                   {
                       "render": function (data, type, full, meta) {
                           //return '<a href="/Report/Details?bbid=' + full.BBID + '">' + full.VehicleName + '</a>';
                           return '<span>' + full.loadtype + '</span>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "LiveStatus/LiveStatusexcelnavkar";
