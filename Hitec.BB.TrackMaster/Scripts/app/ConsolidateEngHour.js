...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        console.log(a);
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Date </th><th>Main Engine Working Hour</th><th>Loading Engine Working Hours</th><th>Idling Time</th><th>Distance</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "AddonAPI/ItriangleConsolidateEngHoursReport";
...
function GetIgnitionReport(downloadType) {
    ...
    var url = apiBase.apiurl + "/AddonAPI/ItriangleConsolidateEngHoursReport";
