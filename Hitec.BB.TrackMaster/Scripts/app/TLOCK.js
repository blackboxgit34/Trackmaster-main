...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th> Lock Time</th><th>UnLock Time</th><th>Lock Location</th><th>UnLock Location</th><th>Duration(Days-hh-mm-ss)</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetConsolidatedTlockStatus";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'T-LOCK_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
