                        ...
                        //},
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                if (full['Status'] == 'Separated') {
                                    selectTag =
                                     '<div class="dropdown">' +
                                       '<button class="button button2 dropdown-toggle" type="button" data-toggle="dropdown">Select Action' +
                                    ...
                                    selectTag =
                                        '<div class="dropdown">' +
                                          '<button class="button button1 dropdown-toggle" type="button" data-toggle="dropdown">Select Action' +
                                          '<span class="caret"></span></button>' +
                                          '<ul class="dropdown-menu">' +
                                            '<li><a href="' + imagepath + '" download="Employee.png">Download Employee Image</a></li>' +
                                            '<li><a target = "_blank" href=/fms/AddEmployee?empid=' + full.EmployeeID + '>Edit</a></li>' +
