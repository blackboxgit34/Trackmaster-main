...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Ignition On Time</th><th>Ignition Off Time</th><th>Location</th><th>Duration(Days-hh-mm-ss)</th></tr></thead>';
...
$(document).ready(function () {
    ...
    $('#dt_basic_Master1 tbody').on('click', 'td.details-control', function () {
...
function GetIdlingReport(downloadType) {
    ...
    table = $('#dt_basic_Master1').DataTable({
        ...
        retrieve: true,
        language: {
            searchPlaceholder: "Search Gensat Name",
            sSearch: ""
        },
        "sAjaxSource": url,
        "iDisplayLength": 20,
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Gensat_Idling_Analysis_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
