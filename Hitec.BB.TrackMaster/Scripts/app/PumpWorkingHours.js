...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Pump On Time</th><th>Pump Off Time</th><th>Pump On Location</th><th>Pump Off Location</th><th>Duration (Days-hh-mm-ss)</th></tr></thead>';
...
function GetIgnitionReport(downloadType) {
    ...
    var url = apiBase.apiurl + "ReportsApi/GetPumpWorkingHoursReport";
    ...
    table = $('#dt_basic_Master').DataTable({
        ...
        retrieve: true,
        language: {
            searchPlaceholder: "Search Pump Name",
            sSearch: ""
        },
        "sAjaxSource": url,
        "iDisplayLength": 20,
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Pump_WorkingHours_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
