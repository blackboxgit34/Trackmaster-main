...
function format(d) {
    ...
    if (data.orderBookingCount > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"' +
            ...
            '<th>Dispatch Date Time</th><th>Customer Name</th><th>Driver Name</th><th>Technician Name</th><th>Weight Dimension</th><th>Total Weight</th><th>Material Type</th><th>Freight Deviation</th><th>Expenditure</th><th>Status (To complete Order <br/>Enter Actual cost)</th><th>Actions</th></tr></thead>';
        a.forEach(function (element) {
            ...
            '<td>' + element.Technician + '</td>' +
            '<td>' + element.Weightdimesion + '</td>' +
