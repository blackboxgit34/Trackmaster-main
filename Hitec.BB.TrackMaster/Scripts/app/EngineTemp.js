...
function GetEngineTempReport() {

    deleteTable();
    
   // var $custid = '1619';
    //var baseUrl = '@System.Configuration.ConfigurationManager.AppSettings["ApiBaseUrl"]';
    //var url = "http://localhost:3970/api/ReportsApi/GetEngineTempreport";
    var url = apiBase.apiurl + "CustomAPI/GetEngineTempreport";
                ...
                { "data": "Highest" },
                 {
                     ...
                     "render": function (data, type, full, meta) {
                         return '<div class="mouseon-examples">' + '<a href="/CustomReport/EngineTempDetailReport">Details</a>' + '</div>';
                     }
                 },
        ]
