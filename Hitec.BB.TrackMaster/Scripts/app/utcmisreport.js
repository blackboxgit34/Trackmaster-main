...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "CustomAPI/utcmisreport";
...
function format(d) {
    ...
    if (d.RouteInfo != null) {
       ...
       var  tableString = '<table id="subTbl" class="table table-bordered" style="width:100%;" >' +
...
function GetTripSummaryReport(tableName, downloadType) {
    ...
    deleteTable();
    var $BBID = '';
    var url = apiBase.apiurl + "CustomAPI/utcmisreport";
