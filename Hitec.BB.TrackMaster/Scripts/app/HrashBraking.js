...
function format(d) {
    ...
    if (data.HarshBrakeCount > 0) {
        var a = data.objharshbrakeReport;
...
function GetHarshBrakingReport() {
    
    deleteTable();
  
    //var baseUrl = '@System.Configuration.ConfigurationManager.AppSettings["ApiBaseUrl"]';
    //var url = "http://localhost:3970/api/Reportsapi/GetHarshBrakeReport";

    var url = apiBase.apiurl + "AdminAPI/GetHarshBrakeReport";
