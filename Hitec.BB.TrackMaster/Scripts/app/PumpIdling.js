...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Pump Idling start Time</th><th>Pump Idling Stop Time</th><th>After Idling</th><th>Location</th><th>Duration(Days-hh-mm-ss)</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetPumpIdlingStatusReport";
...
function GetIdlingReport(downloadType) {
    ...
    table = $('#dt_basic_Master').DataTable({
        ...
        retrieve: true,
        language: {
            searchPlaceholder: "Search Pump No",
            sSearch: ""
        },
        "sAjaxSource": url,
        "iDisplayLength": 20,
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Pump_Idling_Analysis_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
