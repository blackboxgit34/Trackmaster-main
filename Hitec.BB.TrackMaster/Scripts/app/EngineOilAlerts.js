...
function format(d) {
    ...
    if (data.Count > 0) {
        var a = data.EngineOilPressureAlert;
...
function GetEngineOilAlert() {

    deleteTable();
    
   // var $custid = '1619';
    //var baseUrl = '@System.Configuration.ConfigurationManager.AppSettings["ApiBaseUrl"]';
    //var url = "http://localhost:3970/api/ReportsApi/GetEngineOilPressureAlerts";
    var url = apiBase.apiurl + "CustomAPI/GetEngineOilPressureAlerts";
