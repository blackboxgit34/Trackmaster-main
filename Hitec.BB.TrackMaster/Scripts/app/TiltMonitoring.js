...
function format(d) {
    ...
    if (data.Count > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Start Time</th><th>End Time</th><th>Start Location</th><th>End Location</th><th>Duration(Days-hh-mm-ss)</th></tr></thead>';
        a.forEach(function (element) {
            tableString = tableString +
            '<tr>' +
                //'<td>' + d.VehicleName + '</td>' +
                '<td>' + moment(element.StartTime).format("MMM D YYYY, hh:mm:ss a") + '</td>' +
                '<td>' + moment(element.EndTime).format("MMM D YYYY, hh:mm:ss a") + '</td>' +
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetConsolidatedTiltStatus";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Tilt_Analysis_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
