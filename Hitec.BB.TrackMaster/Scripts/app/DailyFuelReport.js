...
function format(d) {
    ...
    if (data.dataCount > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead ><tr><th><b>First IgnitionOn Date:</b></th><th><b>Last IgnitionOff Date:</b></th><th><b>Fuel Filling:</b></th><th><b>Distance:</b></th><th><b>Maxspeed:</b></th><th>Fuel Theft:</th><th><b>SpeedLimit:</b></th><th><b>OverStoppage:</th><th><b>Fuel Consumption:</b></th><th><b>Stoppage Time:</b></th><th><b>Driving duration:</b></th><th><b>Fuel Mileage:</b></th><th><b>Idling Time:</b></th><th><b>Over Speedings:</b></th><th><b>Start Location:</b></th><th><b>Stop Location:</b></th><th>Total Ignition On</th><th>Front Engine Working Hour</th><th>Rear Engine Working Hour</th></tr></thead>';
