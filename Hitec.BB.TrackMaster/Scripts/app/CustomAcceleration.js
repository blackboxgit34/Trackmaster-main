...
function GetOverSpeed(downloadType) {
    ...
    table = $('#dt_basic_Master').DataTable({
        ...
        "fnServerParams": function (param) {
            param.push({ "name": "beginDate", "value": $beginDate }, { "name": "endDate", "value": $endDate }, { "name": "bbid", "value": "" }, { "name": "custid", "value": $custid }, { "name": "downloadType", "value": downloadType }, { "name": "reportName", "value": '' }, { "name": "mode", "value": 'Acceleration' });
        },
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Acceleration_Report_' + sdt + '_To_' + edt;
    var $bbid = '';
