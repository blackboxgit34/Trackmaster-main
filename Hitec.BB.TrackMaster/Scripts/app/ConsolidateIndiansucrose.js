...
//        var a = data.objStoppageReport;
//        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Start Date</th><th>Stop Date</th><th>Location</th><th>Duration(Days-hh-mm-ss)</th><th>Ignition</th><th>AddPoi</th> <th>Poi Location</th></tr></thead>';
//        a.forEach(function (element) {
//            
//            if (element.IgnitionStatus == true)

//            {
//                element.IgnitionStatus = '<label style="color:green";>OFF</label>';
//            }
//            else  
//            {
//                element.IgnitionStatus = '<label style="color:red";>ON</label>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetCombinedindiansucroseReport";
...
function GetallstoppageReport(downloadType) {
    ...
    //var url = "http://localhost:3970/api/Reportsapi/GetAllStoppageReport";
    var select = document.getElementById("interval");
    var $interval = select.options[select.selectedIndex].value;
    var url = apiBase.apiurl + "ReportsApi/GetCombinedindiansucroseReport";
    ...
    table = $('#dt_basic_Master').DataTable({
        ...
        "columns": [
                ...
                //{ "data": "TotalDistance" },
                { "data": "StoppageCount" },
                { "data": "SkippedAuthorisedStoppagecount" },
                //{ "data": "TotalStoppageTime" },

                 { "data": "OverSpeedCount" },
                  { "data": "IgnitionCount" },
                     { "data": "IgnitionDuration" },
                        //{ "data": "DrivingTime" },
                           { "data": "totalIdling" },
                            { "data": "TotalDistance" },
                             { "data": "ManualDistance" },
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Consolidated_Analysis_Report_' + sdt + '_TO_' + edt;
    var $bbid = '';
    var select = document.getElementById("interval");
    var $interval = select.options[select.selectedIndex].value;
