...
function format(d) {
    ...
    if (data.upCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Lift  start Date/Time</th><th>Lift stop Date/Time</th><th>Lift  start Location</th><th>Lift stop Location</th><th>Lift Duration(Days-hh-mm-ss)</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetLiftupReport";
