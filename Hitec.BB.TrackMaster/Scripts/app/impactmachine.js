...
function format(d) {
    ...
    if (data.Count > 0) {
        var a = data.Impactreport;

        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead><tr><th>Impact Time </th><th>Impact Area</th><th>Coordinate</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "AddOnAPI/ForkImpactReport";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Fork_Machine_Impact_Report_' + sdt + '_TO_' + edt;
