...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetContinousDriving";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'ContinousDriving_Report_' + sdt + '_To_' + edt;
    var $bbid = '';
    var url1 = url + "?beginDate=" + $beginDate + "&endDate=" + $endDate + "&bbid=" + $bbid + "&downloadType=" + downloadType + "&reportName=" + reportName + "&mode=over&custId=" + $custid + "&sEcho=" + sEcho + "&iDisplayStart=" + iDisplayStart + "&iDisplayLength=" + iDisplayLength + "&sSearch=" + sSearch + "&iSortCol_0=" + iSortCol_0 + "&sSortDir_0=" + sSortDir_0 + "&mode=Acceleration";
