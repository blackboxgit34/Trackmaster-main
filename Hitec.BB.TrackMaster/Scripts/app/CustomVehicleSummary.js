...
function format(d) {
    ...
    if (data.dataCount > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead><tr><th>Distance</th><th>StoppageTime</th><th>Driving Time</th><th>Idling Time</th><th>Total Hour</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "AddOnAPI/CustomVehicleSummary";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Custom_VehicleSummary_Report_' + sdt + '_To_' + edt;
