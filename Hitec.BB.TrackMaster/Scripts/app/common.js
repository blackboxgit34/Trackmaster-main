...
function showMapWindowWithHouseDetails(bbid, vehname, lat, longi, location, driverName, driverNumber, speed, dateTime, Status) {
    ...
    $("#ShowLocationOnMap").dialog({
        ...
        open: function () {
            ...
            var url = "../report/GetLocationPartialViewWithHouseData?vehname=" + (vehname) + "&lat=" + lat + "&longi=" + longi + "&location=" + (location) + "&driverName=" + driverName + "&driverNumber=" + driverNumber + "&speed=" + speed + "&dateTime=" + dateTime + "&status=" + Status;
            $(this).load(url);
            $(".ui-dialog-titlebar-close").hide();
        },
        buttons: {
