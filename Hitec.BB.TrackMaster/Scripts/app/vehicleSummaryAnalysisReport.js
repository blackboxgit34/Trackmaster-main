function format(d) {
    ...
    if (data.OverCustomCount > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead><tr><th>Date Time</th><th>Location</th><th><span> Speed  </span></th><th><span> Status  </span></th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "Reportsapi/GetSummaryDetailsReport";
...
function DownloadData(url, downloadType) {
    ...
    var reportName = 'Vehicle Summary Analysis' + $beginDate + '_TO_' + $endDate;
    var $bbid = '';
