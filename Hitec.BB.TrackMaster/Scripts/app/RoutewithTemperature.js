...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "CustomAPI/TempratureReport";
...
function GetTripSummaryReport(tableName, downloadType) {
    ...
    deleteTable();
    var $BBID = '';
    var url = apiBase.apiurl + "CustomAPI/TempratureReport";
        ...
        "columns": [
...

                {
                    "render": function (data, type, full, meta) {
                        return '<span style="color:#ff004d;font-size:15px;font-weight:bold;">' + full.tempCountbelowminus18 + ' </span>';

                    }
                },
                      {
                          "render": function (data, type, full, meta) {
                              return '<span style="color:#ff004d;font-size:15px;font-weight:bold;">' + full.temppercentagebelowminus18 + ' %</span>';
                  ...
                  {
                      "render": function (data, type, full, meta) {
                          return '<span style="color:#273f8a;font-size:15px;font-weight:bold;">' + full.tempCountbelowminus17 + ' </span>';

                      }
                  },
                      {
                          "render": function (data, type, full, meta) {
                              return '<span style="color:#273f8a;font-size:15px;font-weight:bold;">' + full.temppercentagebelowminus17 + ' %</span>';
                     ...
                     {
                         "render": function (data, type, full, meta) {
                             return '<span style="color:#ff6767;font-size:15px;font-weight:bold;">' + full.tempCountbelowminus13 + ' </span>';

                         }
                     },
                      {
                          "render": function (data, type, full, meta) {
                              return '<span style="color:#ff6767;font-size:15px;font-weight:bold;">' + full.temppercentagebelowminus13 + ' %</span>';
                    ...
                    {
                        "render": function (data, type, full, meta) {
                            return '<span style="color:#21891d;font-size:15px;font-weight:bold;">' + full.tempCountbelowminus10 + ' </span>';

                        }
                    },
                      {
                          "render": function (data, type, full, meta) {
                              return '<span style="color:#21891d;font-size:15px;font-weight:bold;">' + full.temppercentagebelowminus10 + ' %</span>';
                    ...
                    {
                        "render": function (data, type, full, meta) {
                            return '<span style="color:#4e2c7f;font-size:15px;font-weight:bold;">' + full.tempCountbelowminus9 + ' </span>';

                        }
                    },
                      {
                          "render": function (data, type, full, meta) {
                              return '<span style="color:#4e2c7f;font-size:15px;font-weight:bold;">' + full.temppercentagebelowminus9 + ' %</span>';
                   ...
                   {
                       "render": function (data, type, full, meta) {
                           return '<span style="color:orange;font-size:15px;font-weight:bold;">' + full.Grade + '</span>';
                   ...
                   {
                       "render": function (data, type, full, meta) {
                           return '<span style="color:#FF5733 ;font-size:15px;font-weight:bold;">' + full.COMPONCOUNT + ' %</span>';
                     ...
                     {
                         "render": function (data, type, full, meta) {
                             return '<span style="color:#00FF00;font-size:15px;font-weight:bold;">' + full.COMPOFFCOUNT + ' %</span>';

                         }
                     },
                       {
                           "render": function (data, type, full, meta) {
                               return '<span style="color:#badd99;font-size:15px;font-weight:bold;">' + full.avgtemp + ' C</span>';
