(function (app) {
    ...
    function membershipService(apiService, notificationService, $http, $base64, $rootScope, $cookies) {
        ...
        function login(user, completed) {
            ...
            // apiService.get('http://112.196.27.102:89/' + 'api/commonAPI/AuthorizeUser', config,
        ...
        function loginStaff(user, completed) {
            ...
            apiService.get('http://112.196.27.102:89/' + 'api/commonAPI/AuthorizeStaff', config,
            completed,
            loginFailed);
        }
        ...
        function removeCredentials() {
          ...
          $custid = logindata.data.CustId;
              ...
              apiService.get('http://112.196.27.102:89/' + 'api/commonAPI/Logout', config, function () { }, function () { });
          }
