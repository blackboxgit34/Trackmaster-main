...
function format(d) {
    ...
    if (data.dataCount > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead><tr><th>Vehicle</th><th>Device ID</th><th>Subuser</th><th>LastDate </th></tr></thead>';
        a.forEach(function (element) {
            ...
            '<td>' + element.vehicle + '</td>' +
              ...
              '<td>' + element.subuser + '</td>' +
                '<td>' + moment(element.Lastdata).format("MMM D YYYY, hh:mm:ss a") + '</td>' +
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "AddOnAPI/DisconnectionReport";
