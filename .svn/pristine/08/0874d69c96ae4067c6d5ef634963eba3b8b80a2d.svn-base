function format(d) {
    ...
    if (data.poisCovered > 0) {
        ...
        var tableString = '<table id="subTbl" cellpadding="5" class="table table-hover" cellspacing="0" width="100%"   style = "outline-style: solid; outline-width: thin; outline-color: lightgray; "><thead><tr><th>POI Name</th><th>Out Time</th><th>In Time</th><th>Duration(hh:mm:ss)</th></tr></thead>';
...
function GetEntryExitReport() {
    ...
    //  $custid = '6627';
    var url = baseUrl + "CustomAPI/CustomEntryExitReport";
