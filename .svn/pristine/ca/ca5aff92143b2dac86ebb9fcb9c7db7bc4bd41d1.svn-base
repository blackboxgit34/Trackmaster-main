    ...
    $('#reportrange').daterangepicker({
        ...
        ranges: {
           'Today' : [moment().subtract(0, 'days').startOf('day'), moment()],
            ...
            'Day before Yesterday': [moment().subtract(2, 'days').startOf('day'), moment().subtract(2, 'days').endOf('day')],
            'Two days before Yesterday': [moment().subtract(3, 'days').startOf('day'), moment().subtract(3, 'days').endOf('day')],
            'Three days before Yesterday': [moment().subtract(4, 'days').startOf('day'), moment().subtract(4, 'days').endOf('day')],
            'Four days before Yesterday': [moment().subtract(5, 'days').startOf('day'), moment().subtract(5, 'days').endOf('day')],
            'Five days before Yesterday': [moment().subtract(6, 'days').startOf('day'), moment().subtract(6, 'days').endOf('day')],
