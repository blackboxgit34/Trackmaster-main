...
function GetRadiusReport() {

    deleteTable();
    
    //var $custid = '1619';
    //var baseUrl = '@System.Configuration.ConfigurationManager.AppSettings["ApiBaseUrl"]';
    //var url = "http://localhost:3970/api/ReportsApi/GetRadiusReport";
    var url = apiBase.apiurl + "CustomAPI/GetRadiusReport";
                ...
                { "data": "Highest" },
                 {
                     ...
                     "render": function (data, type, full, meta) {
                         return '<div class="mouseon-examples">' + '<a href="/Customreport/RadiusDetailReport">Details</a>' + '</div>';
                     }
                 },
        ]
