...
function format(d) {
    ...
    if (data.IgnitionOnOffCounter > 0) {
        ...
        var tableString = '<table id="subTbl" class="table table-bordered" cellpadding="5" cellspacing="0" width="100%" ><thead ><tr"><th>Thresher On Time</th><th>Thresher Off Time</th><th>Thresher On Location</th><th>Thresher Off Location</th><th>Duration (Days-hh-mm-ss)</th></tr></thead>';
...
$("#excelExport").click(function () {
    ...
    var url = baseUrl + "ReportsApi/GetThresherWorkingHours";
...
function GetIgnitionReport(downloadType) {
    ...
    //var url = "http://localhost:3970/api/ReportsApi/GetWorkingHoursReport";
    var url = apiBase.apiurl + "ReportsApi/GetThresherWorkingHours";
