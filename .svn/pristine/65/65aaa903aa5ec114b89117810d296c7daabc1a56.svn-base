...
function GetBillInfo() {
    ...
    var url = baseUrl + "InvoiceAPI/GetBillSummary";
    $.ajax({
        url: url,
        type: 'GET',
        data: billDetails,
...
function processdata(data) {
   ...
   // $("#PreviousBal").text(data.PreviousBalance);
    ...
    $("#CurrentCharges").text(parseFloat(data.CurrentCharges).toFixed(2));
    $("#CurrentCharge").text(parseFloat(data.CurrentCharges).toFixed(2));
    $("#PayableAmnt").text(parseFloat(data.PayableAmnt).toFixed(2));
    $("#PayafterCharges").text(parseFloat(data.PayafterCharges).toFixed(2));
    ...
    $("#DiscountPerc").text(parseFloat(data.DiscountPerc).toFixed(2));
    $("#IGST").text(parseFloat(data.IGST).toFixed(2));
    $("#Crow").hide(); $("#Srow").hide(); $("#Irow").show();
    //if (data.State.toLowerCase() == "chandigarh")
    //{
    //    $("#CGST").text(parseFloat(data.CGST).toFixed(2));
    //    $("#SGST").text(parseFloat(data.SGST).toFixed(2));
    //    $("#Crow").show(); $("#Srow").show(); $("#Irow").hide();
    //    $('#adv').css('padding-top', '5px');
    //} else {
    //    $("#IGST").text(parseFloat(data.IGST).toFixed(2)); $("#Crow").hide(); $("#Srow").hide(); $("#Irow").show();
    //}
...
function GetVehicleDetails() {
    ...
    var url = baseUrl + "InvoiceAPI/GetBillDetails";
    var BillPeriodID = getUrlParameter('billperiodid');   
    var FromDate = getUrlParameter('FromDate');
